...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _register() {
    ...
    if (password.length < 6) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('كلمة المرور يجب أن تتكون من 6 أحرف على الأقل')),
      );
      return;
    }

    context.read<AuthCubit>().signUp(email: email, password: password, fullName: name);
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'انضم إلينا لإدارة عقاراتك باحترافية',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.cairo(
                      fontSize: 16,
                      ...
                      return SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: isLoading
                              ...
                              : Text('تسجيل', style: GoogleFonts.cairo(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.white)),
                        ),
                      );
                    },
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Text('لديك حساب بالفعل؟', style: GoogleFonts.cairo()),
                      TextButton(
                        onPressed: () => Navigator.pop(context),
                        child: Text('تسجيل الدخول', style: GoogleFonts.cairo(fontWeight: FontWeight.bold, color: AppColors.primary)),
                      ),
                    ],
                  ),
                ],
